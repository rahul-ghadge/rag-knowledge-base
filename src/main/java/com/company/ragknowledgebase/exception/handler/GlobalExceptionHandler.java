package com.company.ragknowledgebase.exception.handler;
...
/**
 * Global exception handler: maps exceptions to consistent ApiResponse error responses.
 */
@Slf4j
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleFileSizeExceeded(MaxUploadSizeExceededException ex) {
        return ResponseEntity.status(HttpStatus.PAYLOAD_TOO_LARGE)
                .body(ApiResponse.error("File size exceeds maximum allowed limit (50MB)", "FILE_TOO_LARGE"));
    }
